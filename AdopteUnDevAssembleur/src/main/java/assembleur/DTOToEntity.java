...
public class DTOToEntity {
	...
	public static AssociationCdcFonctionnalite dtoAssociationCdcFonctionnaliteToAssociationCdcFonctionnalite(
			DTOAssociationCdcFonctionnalite dtoAssociationCdcFonctionnalite) {
		AssociationCdcFonctionnalite associationCdcFonctionnalite = new AssociationCdcFonctionnalite();
		associationCdcFonctionnalite
				.setIdAssocCdcFonctionnalite(dtoAssociationCdcFonctionnalite
						.getIdAssocCdcFonctionnalite());
		associationCdcFonctionnalite
				.setCdc(dtoCdcToCdc(dtoAssociationCdcFonctionnalite.getCdc()));
		associationCdcFonctionnalite
				.setFonctionnalite(dtoFonctionnaliteToFonctionnalite(dtoAssociationCdcFonctionnalite
						.getFonctionnalite()));
		return associationCdcFonctionnalite;
	}

	public static AssociationDevTechno dtoAssociationDevTechnoToAssociationDevTechno(
			DTOAssociationDevTechno dto) {
	...
	public static AssociationTypeServiceTechno dtoAssociationTypeServTechnoToAssociationTypeServTechno(
			DTOAssociationTypeServiceTechno dto) {
		AssociationTypeServiceTechno entity = new AssociationTypeServiceTechno();
		entity.setIdAssociationTypeServiceTechno(dto
				.getIdAssociationTypeServiceTechno());
		entity.setTechnologie(dtoTechnologieToTechnologie(dto.getTechnologie()));
	...
	public static Departement dtoDepartementToDepartement(
			DTODepartement dtoDepartement) {
	...
	public static Ville dtoVilleToVille(DTOVille dtoVille) {
		...
		ville.setDepartement(dtoDepartementToDepartement(dtoVille
				.getDepartement()));
		return ville;
	}

	public static Fonctionnalite dtoFonctionnaliteToFonctionnalite(
			DTOFonctionnalite dtoFonctionnalite) {
		Fonctionnalite fonctionnalite = new Fonctionnalite();
		fonctionnalite.setIdFonctionnalite(dtoFonctionnalite
				.getIdFonctionnalite());
		...
		fonctionnalite
				.setTypeFonctionnalite(dtoTypeFonctionnaliteToTypeFonctionnalite(dtoFonctionnalite
						.getTypeFonctionnalite()));
		return fonctionnalite;
	}

	public static TypeFonctionnalite dtoTypeFonctionnaliteToTypeFonctionnalite(
			DTOTypeFonctionnalite dtoTypeFonctionnalite) {
		TypeFonctionnalite typeFonctionnalite = new TypeFonctionnalite();
		typeFonctionnalite.setIdTypeFonctionnalite(dtoTypeFonctionnalite
	...
	public static Cdc dtoCdcToCdc(DTOCdc dtoCdc) {
		...
		if (dtoCdc.getDeveloppeur() != null) {
			cdc.setDeveloppeurCdc(dtoDeveloppeurToDeveloppeur(dtoCdc
					.getDeveloppeur()));
		}
	...
	public static Technologie dtoTechnologieToTechnologie(
			DTOTechnologie dtoTechnologie) {
		...
		technologie.setTechnologieLibelle(dtoTechnologie
				.getTechnologieLibelle());
		return technologie;
	}

	public static Developpeur dtoDeveloppeurToDeveloppeur(
	...
	public static Operation dtoOperationToOperation(DTOOperation dto) {
		...
		entity.setTypeOperation(dtoTypeOperationToTypeOperation(dto
				.getTypeOperation()));
	...
	public static TypeOperation dtoTypeOperationToTypeOperation(
			DTOTypeOperation dto) {
	...
	public static Message dtoMessageToMessage(DTOMessage dto) {
		...
		if (dto.getUtilisateur1() != null) {
			entity.setUtilisateur1(dtoUtilisateurToUtilisateur(dto
					.getUtilisateur1()));
		}
		if (dto.getUtilisateur2() != null) {
			entity.setUtilisateur2(dtoUtilisateurToUtilisateur(dto
					.getUtilisateur2()));
		}
		return entity;
	}
	...
	public static Proposition dtoPropositionToProposition(DTOProposition dto) {
		...
		entity.setDeveloppeur(dtoDeveloppeurToDeveloppeur(dto.getDeveloppeur()));
		entity.setTypeProposition(dtoTypePropositionToProposition(dto
				.getTypeProposition()));
		return entity;
	}

	public static TypeProposition dtoTypePropositionToProposition(
			DTOTypeProposition dto) {
	...
	public static TypeService dtoTypeServiceToTypeService(
			DTOTypeService dtoTypeService) {
	...
	public static Livrable dtoLivrableToLivrable(DTOLivrable dto) {
		...
		if (dto.getTypeEvaluation() != null)
			entity.setTypeEvaluation(dtoTypeEvaluationToEvaluation(dto
					.getTypeEvaluation()));
	...
	public static TypeEvaluation dtoTypeEvaluationToEvaluation(
			DTOTypeEvaluation dto) {
	...
	public static Set<AssociationCdcFonctionnalite> listDtoAssociationsCdcFonctionnaliteToAssociationFonctionnalite(
			Set<DTOAssociationCdcFonctionnalite> dtoFonctionnaliteLesAssociationCdcFonctionnalite) {
		Set<AssociationCdcFonctionnalite> listAssociationFonctionnalite = new HashSet<AssociationCdcFonctionnalite>();
		for (DTOAssociationCdcFonctionnalite dto : dtoFonctionnaliteLesAssociationCdcFonctionnalite) {
			listAssociationFonctionnalite
					.add(dtoAssociationCdcFonctionnaliteToAssociationCdcFonctionnalite(dto));
		}
		return listAssociationFonctionnalite;
	}

	public static Set<AssociationDevTechno> listDtoAssoDevTechnoToAssoDevTechno(
			Set<DTOAssociationDevTechno> listDto) {
		Set<AssociationDevTechno> listEntity = new HashSet<AssociationDevTechno>();
		for (DTOAssociationDevTechno dto : listDto) {
			listEntity.add(dtoAssociationDevTechnoToAssociationDevTechno(dto));
		}
		return listEntity;
	}

	public static Set<AssociationTypeServiceTechno> listDtoAssoTypeServTechnoToAssoTypeServTechno(
			Set<DTOAssociationTypeServiceTechno> listDto) {
		Set<AssociationTypeServiceTechno> listEntity = new HashSet<AssociationTypeServiceTechno>();
		for (DTOAssociationTypeServiceTechno dto : listDto) {
			listEntity
					.add(dtoAssociationTypeServTechnoToAssociationTypeServTechno(dto));
		}
		return listEntity;
	}

	public static Set<Operation> listDtoOperationsToOperation(
			Set<DTOOperation> listDto) {
		Set<Operation> listEntity = new HashSet<Operation>();
		for (DTOOperation dto : listDto) {
	...
	public static Set<Message> listDtoMessageToMessage(Set<DTOMessage> listDto) {
		...
		for (DTOMessage dto : listDto) {
			listEntity.add(dtoMessageToMessage(dto));
		}
		return listEntity;
	}

	public static Set<Proposition> listDtoPropositionToProposition(
			Set<DTOProposition> listDto) {
		Set<Proposition> listEntity = new HashSet<Proposition>();
		for (DTOProposition dto : listDto) {
	...
	public static Set<Cdc> listDtoCdcToCdc(Set<DTOCdc> listDto) {
		...
		for (DTOCdc dto : listDto) {
			listEntity.add(dtoCdcToCdc(dto));
		}
		return listEntity;
	}

	public static Set<Livrable> listDtoLivrableToLivrable(
			Set<DTOLivrable> listDto) {
		Set<Livrable> listEntity = new HashSet<Livrable>();
		for (DTOLivrable dto : listDto) {
	...
	public static Set<TypeService> listDtoTypeServToTypeServ(
		...
		for (DTOTypeService dto : listDto) {
